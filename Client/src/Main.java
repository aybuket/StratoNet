...
import static Common.Request.MessageType.Auth_Request;
...
public class Main {
    ...
    private static ApodRequest useApodAPI() throws Exception
    {
        ...
        if (message.equals("1"))
        {
            requestParameters.setDate(getDate());
        }
    ...
    private static Date getDate() throws Exception
    {
        return getDate(Date.getFirstPictureDay());
    }

    private static Date getDate(Date validateDateMin) throws Exception
    {
